...
public class FourthImageScene : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		...
		rsc.prepare_image("myZabuza","Zabuza", get_scene_width(),get_scene_height());
		image4 = add_sprite_for_image(SEImage.for_resource("myZabuza"));
		image4.move(0,0);	
		...
		image3text.set_text("Minato");
		image1text.set_text("Hashirama");
