...
public class ThirdImageScene : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		...
		rsc.prepare_image("myHashirama","Hashirama", get_scene_width(),get_scene_height());
		image3 = add_sprite_for_image(SEImage.for_resource("myHashirama"));
		image3.move(0,0);	
		...
		image2text.set_text("Naruto");
		image1text.set_text("Minato");
		image4text.set_text("Zabuza");
