...
public class MainScene : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		...
		rsc.prepare_image("myNaruto","Naruto",0.5* get_scene_width(),0.5* get_scene_height());
		image1 = add_sprite_for_image(SEImage.for_resource("myNaruto"));
		image1.move(0,0);

		rsc.prepare_image("myMinato","Minato",0.5* get_scene_width(),0.5* get_scene_height());
		image2 = add_sprite_for_image(SEImage.for_resource("myMinato"));
		image2.move(0.5*get_scene_width(),0);

		rsc.prepare_image("myHashirama","Hashirama",0.5* get_scene_width(),0.5* get_scene_height());
		image3 = add_sprite_for_image(SEImage.for_resource("myHashirama"));
		image3.move(0,0.5*get_scene_height());

		rsc.prepare_image("myZabuza","Zabuza",0.5* get_scene_width(),0.5* get_scene_height());
