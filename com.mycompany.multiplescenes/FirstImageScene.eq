...
public class FirstImageScene : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		...
		rsc.prepare_image("myNaruto","Naruto", get_scene_width(),get_scene_height());
		image1 = add_sprite_for_image(SEImage.for_resource("myNaruto"));
		image1.move(0,0);	
		...
		image2text.set_text("Minato");
		image3text.set_text("Hashirama");
